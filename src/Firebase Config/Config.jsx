...
import { getFirestore, collection, addDoc, setDoc, getDoc, onSnapshot, deleteDoc, updateDoc, doc, query, where, getDocs, } from "firebase/firestore";
...
export {
    ...
    db, collection, addDoc, setDoc, getDoc, onSnapshot, deleteDoc, updateDoc, getDocs, doc, query, where,
